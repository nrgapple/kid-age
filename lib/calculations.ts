...
export function getAdultEquivalent(
  ...
  if (kidAgeMinutes <= 0) {
    return { minutes: 0, value: 0, unit: "minutes", raw: "0 minutes" };
  }
 ...
 */
export function formatDuration(totalMinutes: number): DurationDescriptor {
  if (totalMinutes < 1) {
    ...
    return {
      ...
      raw: `${seconds} ${seconds === 1 ? "second" : "seconds"}`,
    };
  }
